    ...
    return (
        <header className="flex flex-col min-h-screen w-full">
            ...
            <main className="flex flex-1 items-center md:px-15 lg:px-22 xl:px-30 2xl:px-44">
                <div>
                    <h1 className="text-[#6633ee] pb-2 text-[.95rem] sm:text-xl lg:text-xl font-mono">Hi, nice to meet you. My name is</h1>
                    ...
                    text-[1.55rem] sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl tracking-tight py-1
